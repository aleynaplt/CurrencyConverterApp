package com.aleynapolat.currencyconverterapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    String[] country = {"AFN","EUR","TR","USD"}; //TODO
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        convertToDropdownTextView = findViewById(R.id.covert_to_dropdown_menu);
        ...
        convertToDropdownTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(new AdapterView<?> parent, View view, int position, long id) {
        ...
        convertButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                try{
                    Double amountToConverter = Double.valueOf(MainActivity.this.amountToConvert.getText().toString());
    ...
    public String getConversionRate(String convertFrom, String convertTo, Double amountToConverter){
